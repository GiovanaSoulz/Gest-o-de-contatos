...
import { TouchableOpacity, Alert, Button, Image, ScrollView, StyleSheet, Switch, Text, TextInput, ToastAndroid, View } from 'react-native';
  ...
  return (
    <View style={estilos.container}>
      ...
      <ScrollView style={{backgroundColor: "#ffe3e0", marginBottom: 100}}>
          ...
          <Image source={require('./assets/gatito_bonito.jpg')} width={500} height={500} style={{alignSelf: "center"}} resizeMode="center" resizeMethod="resize"/>
          <View style={{flexDirection: "row", 
            alignItems: "center", justifyContent: "space-evenly"}}>
            <Text style={{color: "#866d6d", fontSize: 22, fontWeight: "bold"}}>Ativo: </Text>
            <Switch thumbColor="#814040" trackColor = {{
              true: "lightgray",
              false: "gray"
            }} value={false}/>
          </View>
...
const estilos = StyleSheet.create({
  ...
  input: {marginVertical: 20, marginHorizontal: 5, 
              padding: 10, 
              backgroundColor: "#caa2a2", borderColor: " #644141",
